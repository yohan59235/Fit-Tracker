...
function ExosEpaules() {
  const EpaulesExercices = Exercices.filter(
    (exo) => Array.isArray(exo.muscles) && exo.muscles.includes("Epaules")
  );
  return (
    <div className="Exercices_Container">
      {EpaulesExercices.map((exo) => (
