...
function ExosEtirements() {
  const EtirementsExercices = Exercices.filter(
    (exo) => Array.isArray(exo.muscles) && exo.muscles.includes("Etirements")
  );
  return (
    <div className="Exercices_Container">
      {EtirementsExercices.map((exo) => (
