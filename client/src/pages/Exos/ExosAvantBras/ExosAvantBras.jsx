...
function ExosAvantBras() {
  const AvantBrasExercices = Exercices.filter(
    (exo) => Array.isArray(exo.muscles) && exo.muscles.includes("Avant-bras")
  );

  return (
    <div className="Exercices_Container">
      {AvantBrasExercices.map((exo) => (
